...
class ExhibitorCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => BoothCreateNestedManyWithoutExhibitorsInput,
  })
  @ValidateNested()
  @Type(() => BoothCreateNestedManyWithoutExhibitorsInput)
  @IsOptional()
  @Field(() => BoothCreateNestedManyWithoutExhibitorsInput, {
    nullable: true,
  })
...
export { ExhibitorCreateInput as ExhibitorCreateInput };
