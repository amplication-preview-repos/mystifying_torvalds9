...
class BoothUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ExhibitorUpdateManyWithoutBoothsInput,
  })
  @ValidateNested()
  @Type(() => ExhibitorUpdateManyWithoutBoothsInput)
  @IsOptional()
  @Field(() => ExhibitorUpdateManyWithoutBoothsInput, {
    nullable: true,
  })
...
export { BoothUpdateInput as BoothUpdateInput };
